...
//        when(propertyOwnerServices.registerProperty(dto.getOwnerVatNumber(), dto.getPropertyId(), dto.getPropertyAddress(), dto.getYearOfConstruction(), vadto.getPropertyType()).thenReturn(true);
//
//        Response response = userResource.registerProperty(dto);
//        assertEquals(200, response.getStatus());
